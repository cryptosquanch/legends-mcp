 ...
 */
function selectLegendsForQuestion(question, maxLegends = 3) {
 ...
 */
function getPerspectiveHint(legend) {
 ...
 */
export function partyMode(input) {
 ...
 */
function buildDiscussionPrompt(participants, question) {
 ...
 */
export function formatPartyMode(response) {
    const lines = [
